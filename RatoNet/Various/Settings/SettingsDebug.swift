...
class SettingsDebugFace: Codable, ObservableObject {
    ...
    @Published var showRatoNet = false

    enum CodingKeys: CodingKey {
        case showBlur,
             showBlurBackground,
             showRatoNet,
             showMoblin // Mantido para compatibilidade com dados antigos
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.showMoblin, showRatoNet)
    }
    ...
    required init(from decoder: Decoder) throws {
        ...
        showRatoNet = container.decode(.showMoblin, Bool.self, false)
    }
}
