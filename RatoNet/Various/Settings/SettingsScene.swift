...
class SettingsWidgetBrowser: Codable, ObservableObject {
    ...
    @Published var ratonetAccess: Bool = false
    ...
    enum CodingKeys: CodingKey {
        case url,
             ...
             styleSheet,
             ratonetAccess,
             moblinAccess // Mantido para compatibilidade com dados antigos
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(.moblinAccess, ratonetAccess)
    }
    ...
    required init(from decoder: Decoder) throws {
        ...
        ratonetAccess = container.decode(.moblinAccess, Bool.self, false)
    }
}
...
class SettingsWidgetScoreboardPlayer: Codable, Identifiable, ObservableObject, Named {
    static let baseName = String(localized: "🇸🇪 RatoNet")
    var id: UUID = .init()
