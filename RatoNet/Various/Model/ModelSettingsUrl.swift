...
extension Model {
    private func handleSettingsUrlsDefaultStreams(settings: RatoNetSettingsUrl) {
    ...
    private func handleSettingsUrlsDefaultQuickButtons(settings: RatoNetSettingsUrl) {
    ...
    private func handleSettingsUrlsDefaultWebBrowser(settings: RatoNetSettingsUrl) {
    ...
    private func handleSettingsUrlsDefaultRemoteControl(settings: RatoNetSettingsUrl) {
    ...
    private func handleSettingsUrlsDefault(settings: RatoNetSettingsUrl) {
    ...
    func handleSettingsUrl(url: URL) -> String? {
        ...
        do {
            settings = try RatoNetSettingsUrl.fromString(query: query)
        } catch {
